...
%±äµÀ
% [x1,y1,theta1,kr1]=straight([0,-2],[10,-2],0,count);
% [x2,y2,theta2,kr2]=arc([10,-2],[33,0],0,pi/20,count);
% [x3,y3,theta3,kr3]=arc([33,-0.1886],[60,2],pi/20,0,count);
% [x4,y4,theta4,kr4]=straight([60,1.9367],[70,1.93],0,count);
% xr=[x1,x2,x3,x4];
% yr=[y1,y2,y3,y4];
...
% ×ªÍä
% [x1,y1,theta1,kr1]=straight([0,0],[10,0],0,count);
% [x2,y2,theta2,kr2]=arc([10,0],[22,12],0,pi/2,count);
% [x3,y3,theta3,kr3]=straight([22,12],[22,32],pi/2,count);
% 
% xr=[x1,x2,x3];
% yr=[y1,y2,y3];
% thetar=[theta1,theta2,theta3];
% kappar=[kr1,kr2,kr3];


scatter(xr,yr)
hold on
scatter(xr(1),yr(2),'r','filled')
